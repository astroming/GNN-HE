...
parser.add_argument('--dataset', type=str, default='ogbl-collab')  # ddi collab ppa citation2
parser.add_argument('--result_appendix', type=str, default='_test', help="if '', time as appendix")
...
parser.add_argument('--use_dist', type=bool, default=True, help="whether to use shortest path distance")
...
parser.add_argument('--max_aa', type=int, default=200)
parser.add_argument('--max_ja', type=int, default=10)
...
parser.add_argument('--heurisctic_reproduce', type=bool, default=True, help="whether to re-produce heuristics, False would speed up training but may decrease the performance")
...
parser.add_argument('--heurisctic_reuse', type=bool, default=False)
parser.add_argument('--neg_size', type=float, default=200, help="size of data_neg_train: neg_size * len(split_edge['train']['edge'])")


# model setting
parser.add_argument('--atten_type', type=str, default='Multiply', help="attention mechnism. Options: Concat, Cosine, Multiply, no_atten, with repsect to GAT, AGNN, Transformer and GCN")
parser.add_argument('--atten_combine', type=str, default='only_atten', help="type of combining original adj with attention (if use). must be: plus, multiply or only_atten")
parser.add_argument('--bias', type=bool, default=True)
parser.add_argument('--dim_node_emb', type=int, default=32)
parser.add_argument('--dim_encoding', type=int, default=32, help="dim for encoding heuristics, etc.")
parser.add_argument('--dim_atten', type=int, default=5, help="dim for matrix multiplication. Should be small for large graph")
...
parser.add_argument('--n_heads', type=int, default=2, help="multiply head CNN")
...
# learning setting
parser.add_argument('--num_workers', type=int, default=26)
...
#parser.add_argument('--dropout_adj', type=float, default=0.0)
parser.add_argument('--lr', type=float, default=0.001)
parser.add_argument('--lr_mini', type=float, default=0.0001, help="lr stops decreasing at lr_mini")
parser.add_argument('--scheduler_gamma', type=float, default=0.9995)
...
parser.add_argument('--batch_num', type=int, default=2, help="number of batches trained in an epoch")
