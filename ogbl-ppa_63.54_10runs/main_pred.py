...
parser.add_argument('--dataset', type=str, default='ogbl-ppa')  # ddi collab ppa citation2
...
parser.add_argument('--use_dist', type=bool, default=False, help="whether to use shortest path distance for edge")
...
parser.add_argument('--ram_save', type=bool, default=False)
## feature max
parser.add_argument('--max_dist', type=int, default=5)
parser.add_argument('--max_cn', type=int, default=10)
parser.add_argument('--max_ja', type=int, default=10)
parser.add_argument('--max_aa', type=int, default=20)
parser.add_argument('--max_ra', type=int, default=20)
parser.add_argument('--max_degree', type=int, default=10)
# magnitude for ja aa ra
parser.add_argument('--mag_ja', type=int, default=10)
parser.add_argument('--mag_aa', type=int, default=1)
...
parser.add_argument('--neg_size', type=float, default=30, help="size of data_neg_train: neg_size * len(split_edge['train']['edge'])")
# mask setting
...
parser.add_argument('--mask_neg', type=float, default=0.5, help="the number of neg neighbor per node averagely.")
parser.add_argument('--mask_neg_dist', type=int, default=10, help="the number of neg neighbor per node averagely.")
parser.add_argument('--mask_atten', type=str, default='Multiply', help="attention mechnism. options: Concat, Cosine, Multiply, no_atten")
...
parser.add_argument('--mask_combine', type=str, default='only_atten', help="type of combining mask with self-attention. options: only_atten, plus, multiply")
...
parser.add_argument('--dim_atten', type=int, default=2, help="dim for matrix multiplication. should be small for large graph")
parser.add_argument('--n_layers', type=int, default=2)
parser.add_argument('--n_heads', type=int, default=1)
parser.add_argument('--n_layers_mlp', type=int, default=3)
...
parser.add_argument('--clip_grad_norm', type=float, default=5.0, help="whether to use clip_grad_norm_ in training")
...
parser.add_argument('--batch_num', type=int, default=500, help="number of batches trained in an epoch")
